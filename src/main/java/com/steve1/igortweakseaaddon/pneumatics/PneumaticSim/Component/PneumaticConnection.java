...
public class PneumaticConnection extends Component {
    ...
    public void start_step(double time) {
        ...
        if (Math.abs(speed)>small_value && Math.abs(acceleration_pressure)>small_value) {
    ...
    public void sanitize() {
        ...
        length=sanitize_number(length,1);
        resistance=sanitize_number(resistance,base_air_resistance);
        to_move_mass=sanitize_number(to_move_mass,0);
    }
