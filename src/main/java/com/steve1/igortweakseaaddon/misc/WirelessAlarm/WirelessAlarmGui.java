package com.steve1.igortweakseaaddon.misc.WirelessAlarm;

import mods.eln.gui.*;

import static mods.eln.i18n.I18N.tr;

public class WirelessAlarmGui extends GuiScreenEln {
    GuiTextFieldEln channel;
    private WirelessAlarmRender render;

    WirelessAlarmGui.AggregatorBt buttonBigger, buttonSmaller, buttonToogle;
    ...
    class AggregatorBt extends GuiButtonEln {
        ...
        public void onMouseClicked() {
            render.clientSetByte(WirelessAlarmElement.setSelectedAggregator, id);
    ...
    public WirelessAlarmGui(WirelessAlarmRender render) {
        this.render = render;
    }
    ...
    public void initGui() {
        ...
        int x = 6;
        int y = 6 + 12 + 4;
        add(buttonBigger = new WirelessAlarmGui.AggregatorBt(x, y, w, 20, tr("Biggest"), (byte) 0));
        x += 2 + w;
        add(buttonSmaller = new WirelessAlarmGui.AggregatorBt(x, y, w, 20, tr("Smallest"), (byte) 1));
        x += 2 + w;
        add(buttonToogle = new WirelessAlarmGui.AggregatorBt(x, y, w, 20, tr("Toggle"), (byte) 2));
    ...
    public void guiObjectEvent(IGuiObject object) {
        if (object == channel) {
            render.clientSetString(WirelessAlarmElement.setChannelId, channel.getText());
        }
