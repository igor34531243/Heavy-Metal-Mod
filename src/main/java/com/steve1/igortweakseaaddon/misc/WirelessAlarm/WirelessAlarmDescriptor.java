...
public class WirelessAlarmDescriptor extends SixNodeDescriptor {
    ...
    public WirelessAlarmDescriptor(String name, Obj3D obj, int light, String soundName, double soundTime, float soundLevel, int range) {
        super(name, WirelessAlarmElement.class, WirelessAlarmRender.class);
